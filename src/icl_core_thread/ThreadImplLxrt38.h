 ...
 * \date    2010-07-01
 *
 * \brief   Contains icl_core::thread::ThreadImpl for RTAI/LXRT 3.8
 *
 * \b icl_core::thread::ThreadImpl for RTAI/LXRT 3.8
 *
 ...
 */
//----------------------------------------------------------------------
#ifndef ICL_CORE_THREAD_THREAD_IMPL_LXRT38_H_INCLUDED
#define ICL_CORE_THREAD_THREAD_IMPL_LXRT38_H_INCLUDED
 ...
 *  specific functions.
 */
class ThreadImplLxrt38 : public ThreadImpl, protected virtual icl_core::Noncopyable
{
public:
  ThreadImplLxrt38(Thread *thread, const icl_core::String& description,
